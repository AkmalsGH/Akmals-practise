...
def test_registration_page_with_empty_name_field(web_browser):
    ...
    reg_page.last_name_field.send_keys("Аширм")
    reg_page.email_or_mobile_phone_field.send_keys("aashirmukh@gmail.com")
    reg_page.password_field.send_keys("AA2653524b")
    reg_page.password_confirmation_field.send_keys("AA2653524b")
...
def test_registration_with_an_incorrect_value_in_the_last_name_field(web_browser):
    ...
    auth_page.registration_link.click()
    reg_page = RegPage(web_browser, auth_page.get_current_url())
    reg_page.name_field.send_keys("Юзер")
    reg_page.last_name_field.send_keys("йцукенгшщзфывапролджэячсмить")
    reg_page.email_or_mobile_phone_field.send_keys("user_123@mail.ru")
    reg_page.password_field.send_keys("AA26535b")
    reg_page.password_confirmation_field.send_keys("AA26535b")
    reg_page.continue_button.click()
    reg_page.error_message_name.is_visible()
...
def test_registration_of_an_already_registered_user(web_browser):
    ...
    auth_page.registration_link.click()
    reg_page = RegPage(web_browser, auth_page.get_current_url())
    reg_page.name_field.send_keys("Акмал")
    reg_page.last_name_field.send_keys("Аширм")
    reg_page.email_or_mobile_phone_field.send_keys("+79600568846")
...
def test_incorrect_password_during_registration(web_browser):
    ...
    reg_page.last_name_field.send_keys("Аширм")
    reg_page.email_or_mobile_phone_field.send_keys("aashirmukh@gmail.com")
    reg_page.password_field.send_keys("AA265")
    reg_page.password_confirmation_field.send_keys("AA265")
    reg_page.continue_button.click()
...
def test_password_and_password_confirmation_do_not_match(web_browser):
    ...
    reg_page.email_or_mobile_phone_field.send_keys("aashirmukh@gmail.com")
    reg_page.password_field.send_keys("AA2653524b")
    reg_page.password_confirmation_field.send_keys("AA2653524a")
    reg_page.continue_button.click()
...
def test_invalid_email_or_mobile_phone(web_browser):
    ...
    reg_page.name_field.send_keys("Акмал")
    reg_page.last_name_field.send_keys("Аширм")
    reg_page.email_or_mobile_phone_field.send_keys("aashirmukhgmail.com")
    reg_page.password_field.send_keys("AA2653524b")
    reg_page.password_confirmation_field.send_keys("AA2653524b")
    reg_page.continue_button.click()
...
def test_authorization_of_a_user_with_an_invalid_password(web_browser):
    page = AuthPage(web_browser)
    page.phone.send_keys('+79600568846')
...
def test_authorisation_valid(web_browser):
    page = AuthPage(web_browser)
    page.phone.send_keys("+79600568846")
    page.password.send_keys("AA2653524")
    page.btn_login.click()
